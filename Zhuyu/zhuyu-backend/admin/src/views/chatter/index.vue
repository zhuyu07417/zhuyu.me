        ...
        <el-form-item label="图片">
          <div class="flex flex-wrap gap-2">
            ...
            >
              ...
              <button
                type="button"
                class="absolute top-0 right-0 w-4 h-4 flex items-center justify-center rounded-full bg-black/50 text-white/90 text-[10px] leading-none cursor-pointer hover:bg-black/80 transition-colors"
