"""更新 oss_utils.py 为完整安全版"""
import os

file_path = "/path/to/your/site/zhuyu-main/zhuyu-backend/app/oss_utils.py"

new_content = '''"""OSS 文件删除工具（完整安全版 - 检查所有引用）"""
import json
import oss2
