    ...
    <div className="rounded-2xl bg-white/50 dark:bg-slate-800/60 backdrop-blur-xl border border-white/30 dark:border-white/10 shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
      <div className="p-3 md:p-5">
        <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-3">
          {comment.github_user ? (
            <img src={comment.github_user.avatar} alt="" className="w-6 h-6 md:w-9 md:h-9 rounded-full object-cover" crossOrigin="anonymous" referrerPolicy="no-referrer"
            />
          ) : (
          ...
          <div className="flex-1 min-w-0">
            ...
            {comment.github_user?.type === "qq" && <span className="text-[10px] ml-1.5 px-1.5 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400">QQ</span>}
          </div>
